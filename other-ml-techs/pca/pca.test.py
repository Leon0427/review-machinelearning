...
lr1 = LogisticRegression(solver="liblinear",multi_class="auto")
lr2 = LogisticRegression(solver="liblinear",multi_class="auto")
lr3 = LogisticRegression(solver="liblinear",multi_class="auto")
lr4 = LogisticRegression(solver="liblinear",multi_class="auto")
lr1.fit(X,y)
lr2.fit(X2,y)
lr3.fit(X3,y)
lr4.fit(X4,y)
